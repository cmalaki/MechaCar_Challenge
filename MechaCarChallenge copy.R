mecha_cars<- read.csv(file="/Users/rotation/Desktop/DataClass/Module_15/MechaCar_mpg.csv")
...
#Deliverable 2
susp_coil<- read.csv(file="/Users/rotation/Desktop/DataClass/Module_15/Suspension_Coil.csv", check.names=F,stringsAsFactors = F)
